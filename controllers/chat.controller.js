...
export const addMembers = TryCatch(async (req, res, next) => {
  ...
  const allUniqueMembers = allNewMembers
  ...
  if (chat.members.length > 10) {
    return next(new ErrorHandler("Group chat can have max 10 members", 400));
  }
...
export const deleteChat = TryCatch(async (req, res, next) => {
  ...
  // Here we have to delete all the messages as well as attachments from cloudinary
